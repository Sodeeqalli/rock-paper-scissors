...
class ImpossibleMode extends StatefulWidget {
  const ImpossibleMode({super.key, required this.back, required this.restart});
  final void Function() back;
  final void Function() restart;
  @override
  State<StatefulWidget> createState() {
    return _ImpossibleModeState();
  }
}

class _ImpossibleModeState extends State<ImpossibleMode> {
  int max = maxscore;
  int num1 = 1;
  int num2 = 5;
  int score2 = 0;
